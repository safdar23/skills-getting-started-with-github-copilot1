...
activities = {
    ...
    "Drama Club": {
        "description": "Create theatrical performances and develop stagecraft skills",
        "schedule": "Thursdays, 5:00 PM - 6:30 PM",
        "max_participants": 20,
        "participants": ["sarah@mergington.edu", "noah@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Practice advanced math problems and prepare for competitions",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["oliver@mergington.edu", "ava@mergington.edu"]
    },
    "Science Research Club": {
        "description": "Work on science experiments and research projects",
